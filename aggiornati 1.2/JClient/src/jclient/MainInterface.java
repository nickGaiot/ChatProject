...
public class MainInterface extends javax.swing.JFrame {
    ...
    public void addMessage(String[] message){
        ...
        if(destCheckBox.isSelected()) recipient= "[" + message[1] + "]";
        chatTextPane.setText(chatTextPane.getText() /*+ time*/ + recipient + writer + addrWriter + ": " + text + "\n");
    }
    ...
    private boolean isHostnameValido(String hostname){
        ...
        if(hostname.equalsIgnoreCase(MyClient.KW_S) || hostname.equalsIgnoreCase(MyClient.KW_L) || hostname.equalsIgnoreCase(MyClient.KW_G)) return false;
        return true;
    }
    ...
    private void initComponents() {
        ...
        chatTextPane.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        messageLabel.setText("Invia Messaggio");
        ...
        selectButton.setText("SELEZIONA/DESELEZIONA");
    ...
    private void sendButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendButtonActionPerformed
        ...
        if(message.trim().length() > 0) client.sendMessage(recipient, message);
    ...
    private void passwordMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_passwordMenuItemActionPerformed
        new Thread(){
            ...
            public void run() {
                ...
                if(password != null) client.sendPassword(password);
            }
        }.start();
    ...
    private void selectButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectButtonActionPerformed
        ...
        if(this.recipient.equals(recipient)){
            this.recipient= MyClient.KW_G;
            messageLabel.setText("Invia Messaggio");
        }
        else{
            this.recipient= recipient;
            messageLabel.setText("Invia Messaggio (desinazione " + recipient + ")");
        }
