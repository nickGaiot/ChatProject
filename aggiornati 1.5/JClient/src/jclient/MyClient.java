...
public class MyClient implements Runnable{
    ...
    public static final String KW_S= "SERVER", KW_C= "CLIENT", KW_L= "local", KW_G= "global"; //key Words
    ...
    public static final String C_Client= "JClient:closed_connection:", C_Server= "JServer:cosed_connection:"; //Closed
    ...
    public void run(){
        ...
        try{
            do{
                ...
                else if(messaggio.startsWith(M_Host)) hostname= messaggio.substring(M_Host.length());
        ...
        disconnettiti();
        addLocalMessage(KW_L, "TI SEI DISCONNESSO");
    }
    ...
    public void addLocalMessage(String writer, String text){
        String[] message= new String[]{writer, KW_L, String.valueOf(System.currentTimeMillis()), text};
