    ...
    class Connection implements Runnable {
        ...
        private void initConnection() throws IOException{
            ...
            if(!bannato){
                ...
                sendClientAll(this);
                interf.reloadClients();
                if(conn == null) sendMessageAll(KW_G, "BENVENUTO " + hostname.toUpperCase() + "!");
                else sendMessageAll(KW_G, hostname.toUpperCase() + " SI E' RICONNESSO");
            }
        }
        ...
        private void closeAll(String messaggio){
            if(!client.isClosed()){
                try{
                    sendMessage(KW_G, KW_L, messaggio);
                ...
                sendMessageAll(KW_G, hostname.toUpperCase() + " SI E' DISCONNESSO: " + messaggio.toUpperCase());
                sendClientAll(this);
                interf.reloadClients();
            }
        }
